...
class TestSecurityMixin:
  ...
  def _hasImplicitSecurity(self, obj, method):
    return not (hasattr(method, '__roles__') and
  ...
  def _checkObjectAllMethodProtection(self, obj):
    ...
    for method_id in dir(obj):
      ...
      if isinstance(method, MethodType) and \
        ...
        self._isMethodPublishable(method) and self._hasImplicitSecurity(obj, method):
