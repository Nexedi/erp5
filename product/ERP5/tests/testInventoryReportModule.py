...
class TestInventoryReportModule(TestOrderMixin, ERP5TypeTestCase):
  """
  ...
  def getBusinessTemplateList(self):
    """
    """
    return super(TestInventoryModule, self).getBusinessTemplateList() + ('erp5_accounting',)
  ...
  def test_01_checkCalculateProduct(self, run=run_all_test):
    """
