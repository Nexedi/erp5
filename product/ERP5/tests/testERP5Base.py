...
class TestERP5Base(ERP5TypeTestCase):
  ...
  def test_CoordinateReachability(self):
    ...
    self.assertEqual(telephone.getValidationState(), 'reachable')
    telephone.declareUnreachable()
    self.assertEqual(telephone.getValidationState(), 'unreachable')
    ...
    self.assertEqual(telephone.getValidationState(), 'unreachable')
    # Fax
    fax = person.newContent(portal_type='Fax')
    self.assertEqual(fax.getValidationState(), 'reachable')
    self.tic()
    fax.declareUnreachable()
    self.assertEqual(fax.getValidationState(), 'unreachable')
    ...
    self.assertEqual(email.getValidationState(), 'reachable')
    self.tic()
    email.declareUnreachable()
    self.assertEqual(email.getValidationState(), 'unreachable')
    email.setCoordinateText('test@text.com')
    self.assertEqual(email.getValidationState(), 'reachable')
    # External Identifier
