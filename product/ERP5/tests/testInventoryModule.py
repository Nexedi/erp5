...
class TestInventoryModule(TestOrderMixin, ERP5TypeTestCase):
  ...
  def stepCreateSalesPackingListEUROToUSD(self, sequence=None,
    ...
    self.stepCreateSalesPackingList(
      ...
      price = 50,
      create_line = True,
      at_date = DateTime('2018/06/11 01:00:00 GMT+0'),
  ...
  def stepTestCalculateProduct(self, sequence=None, sequence_list=None, **kw):
    ...
    self.assertEqual(inventory_report_line_list[3].total_price, 134*32*6.95)
    self.assertEqual(inventory_report_line_list[4].total_quantity, 135)
    self.assertEqual(inventory_report_line_list[4].total_price, 135*33*6.95)
    ...
    self.assertEqual(inventory_report_line_list[2].total_price, 45*80*0.13)
    ...
    self.assertEqual(inventory_report_line_list[2].total_price, 50*50*1.14 + 35*123*1.14)
    self.assertEqual(inventory_report_line_list[3].total_quantity, 200)
    self.assertEqual(inventory_report_line_list[3].total_price, 50*200*0.14)
    self.assertEqual(inventory_report_line_list[4].total_quantity, 201)
    self.assertEqual(inventory_report_line_list[4].total_price, 51*201*0.14)
