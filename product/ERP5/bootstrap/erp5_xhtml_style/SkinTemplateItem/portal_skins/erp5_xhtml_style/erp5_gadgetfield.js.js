...
(function (window, rJS, RSVP, document, console) {
  ...
  rJS(window)
    ...
    .allowPublicAcquisition('translate', function (text) {
      return text;
    })
    .allowPublicAcquisition('getTranslationList', function (text_list) {
      return text_list;
    })
    .allowPublicAcquisition('translateHtml', function (html) {
      return html;
    })
