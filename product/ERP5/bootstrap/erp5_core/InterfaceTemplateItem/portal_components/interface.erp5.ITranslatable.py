...
class ITranslatable(Interface):
  ...
  def getLanguageList(version=None):
    """
  ...
  def getOriginalLanguage():
    """
    Returns the original language of this document. The original
    language of a document is defined as the language of
    the first document with same reference created in the system.
    """
