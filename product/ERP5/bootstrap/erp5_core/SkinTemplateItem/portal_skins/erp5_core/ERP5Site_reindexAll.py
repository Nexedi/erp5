...
catalog_id_list = [portal.portal_catalog.getSQLCatalog().id]
...
for sql_catalog_id in catalog_id_list:
  ...
  folder_tag = 'module_%s'%sql_catalog_id
  folder_after_tag = ('category_%s'%sql_catalog_id, 'person_stage_1_%s'%sql_catalog_id, 'group_person_stage_1')
  object_tag = 'document_%s'%sql_catalog_id
  object_after_tag = folder_after_tag
  ...
  preference_tag = 'portal_preferences_%s'%sql_catalog_id
  ...
  folder_tag = 'module_%s'%sql_catalog_id
  folder_after_tag = ('category_%s'%sql_catalog_id, 'document_%s'%sql_catalog_id, 'person_stage_1_%s'%sql_catalog_id, 'group_person_stage_1', preference_tag)
  object_tag = 'simulation_%s'%sql_catalog_id
  object_after_tag = folder_after_tag
  ...
  # XXX: Hack to avoid even trying to index these objects
  restricted_tool_id_list = ( 'portal_alarms', 'portal_activities',
  ...
  folder_tag = 'module_%s'%sql_catalog_id
  folder_after_tag = ('category_%s'%sql_catalog_id, 'person_stage_1_%s'%sql_catalog_id, 'group_person_stage_1', preference_tag)
  object_tag = 'document_%s'%sql_catalog_id
  object_after_tag = folder_after_tag
  object_priority = 2 + additional_priority
