...
def getCategoryChildCompactLogicalPathItemList(base_category, **kw):
  return [i for i in base_category.getCategoryChildCompactLogicalPathItemList(base=1) if i[1] and ctool.restrictedTraverse(i[1]).getValidationState() in ("embedded", "published", "protected")]  # [:]
