      ...
      if tested_base_category_list != []:
        ...
        if category_list:
          ...
          for join_category_list, join_list in (
            ...
            (left_join_category_list, left_join_list),
          ):
          ...
          # categories, which inserts a
          #   base_category_uid=0, category_uid=0, strict_category_membership=1
          # line when indexed predicate membership_criterion_category_list
          # is empty.
