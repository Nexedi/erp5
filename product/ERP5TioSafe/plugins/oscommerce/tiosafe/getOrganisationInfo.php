<?php
  /**
   * Retrieves the info an organisation
   * The info are in the address book table
   */
  ...
  /*if (!postOK('organisation_id') or !verifyExistence(TABLE_ADDRESS_BOOK, 'address_book_id', $_POST['organisation_id'])) {
