...
class TestERP5BankingCashSortingIncident(TestERP5BankingMixin, ERP5TypeTestCase):
  """
    This class is a unit test to check the module of Cash Sorting Incident
  ...
  def getCashSortingIncidentModule(self):
    ...
    """
    return getattr(self.getPortal(), 'cash_sorting_incident_module', None)
  ...
  def stepCheckObjects(self, sequence=None, sequence_list=None, **kwd):
    ...
    # check that CashSortingIncident Module was created
  ...
  def stepTryPlanCashSortingIncidentWithTwoDifferentLines(self, sequence=None, sequence_list=None, **kwd):
    """
    """
    ...
    self.assertRaises(ValidationFailed, self.workflow_tool.doActionFor, self.cash_sorting_incident, 'plan_action', wf_id='cash_sorting_incident_workflow')
    # execute tic
    self.stepTic()
