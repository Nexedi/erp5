...
class TestERP5BankingMoneyDepositTransfer(TestERP5BankingMixin, ERP5TypeTestCase):
  ...
  def stepCreateMoneyDepositTransfer(self, sequence=None, sequence_list=None, **kwd):
    ...
    self.money_deposit_transfer = self.money_deposit_transfer_module.newContent(id='money_deposit_transfer_1', portal_type='Money Deposit Transfer', source_value=self.usual_cash, destination_value=self.tri, source_total_asset_price=52400.0)
    # execute tic
    self.stepTic()
