...
class IndexableObjectWrapper(object):
      ...
      if result is None:
        ...
        for user_info in portal.acl_users.searchUsers(id=tuple(localroles), exact_match=True):
          ...
          try:
            ...
            LOG(
              'ERP5CatalogTool.IndexableObjectWrapper',
              PROBLEM,
    ...
    def __repr__(self):
      return '<Products.ERP5Catalog.ERP5CatalogTool.IndexableObjectWrapper'\
...
class ERP5CatalogTool (BaseTool, ZCatalog, CMFCoreCatalogTool):
    """
    ...
    def catalogObjectList(self, object_list, *args, **kw):
        ...
        if isinstance(m, GroupedMessage):
          ...
          super(ERP5CatalogTool, self).catalogObjectList(object_list, *args, **kw)
