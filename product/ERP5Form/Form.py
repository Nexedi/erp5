          ...
          if self.pt == 'form_view':
            ...
            for group_name in self.get_groups():
              ...
              for index, field in enumerate(field_list):
                if translated_workflow_state_field_re.match(field.id):
                  ...
                  all_bottom_fields_are_workflow_state_fields = {True} == {
                      translated_workflow_state_field_re.match(field.id) is not None
                      for field in field_list[:index]}
                ...
                if not_translated_workflow_state_field_re.match(field.id):
                  addMessage(
