...
Zope2_zpublisher_validation_hook_orig = Zope2.zpublisher_validation_hook
def Zope2_zpublisher_validation_hook(request, user):
  ...
  # was authenticated. This is a more neutral implementation location.
  if user.getUserName() != 'Anonymous User':
    request.response.setHeader('Cache-Control', 'private')
  Zope2_zpublisher_validation_hook_orig(request, user)
Zope2.zpublisher_validation_hook = Zope2_zpublisher_validation_hook
