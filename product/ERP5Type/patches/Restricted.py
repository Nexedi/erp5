...
series_black_list = ['to_csv', 'to_json', 'to_pickle', 'to_excel', 'to_hdf',
...
pandas_black_list = ['read_csv', 'read_json', 'read_pickle', 'read_fwf',
...
dataframe_black_list = ['to_csv', 'to_parquet', 'to_pickle', 'to_hdf',
