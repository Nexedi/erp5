...
Options:
  ...
  --erp5_sql_isolated_connection_string=STRING
                             ZSQL Connection string for erp5_sql_isolated_connection
...
def main(argument_list=None):
  ...
  for opt, arg in opts:
    ...
    elif opt == "--erp5_sql_isolated_connection_string":
      os.environ["erp5_sql_isolated_connection_string"] = arg
  ...
  if "erp5_sql_isolated_connection_string" not in os.environ and "erp5_sql_connection_string" in os.environ:
    os.environ["erp5_sql_isolated_connection_string"] = os.environ["erp5_sql_connection_string"]
  if "cmf_activity_sql_connection_string" not in os.environ and "erp5_sql_isolated_connection_string" in os.environ:
    os.environ["cmf_activity_sql_connection_string"] = os.environ["erp5_sql_isolated_connection_string"]
