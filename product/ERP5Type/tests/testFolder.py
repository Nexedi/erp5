...
class TestFolder(ERP5TypeTestCase, LogInterceptor):
    ...
    def test_fragmentedLength(self):
      ...
      self.assertTrue(isinstance(folder_dict['_count'], Length), folder_dict['_count'])
      ...
      self.assertTrue(isinstance(fragmented_length, FragmentedLength), fragmented_length)
