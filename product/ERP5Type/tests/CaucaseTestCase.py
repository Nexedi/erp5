...
class CaucaseTestCase(object):
  ...
  def bootstrapCaucaseConnector(self):
    ...
    test_caucase_connetor = getattr(portal_web_service, "test_caucase_connetor", None)
    if test_caucase_connetor is None:
      test_caucase_connetor = portal_web_service.newContent(
        id="test_caucase_connetor",
        portal_type="Caucase Connector",
        reference="default",
      )
      test_caucase_connetor.validate()

    test_caucase_connetor.edit(
        url_string=self.caucase_url,
        user_key=None,
        user_certificate=None)
    
    test_caucase_connetor._bootstrapCaucaseConfiguration()
