...
class TestZeleniumCore(ERP5TypeFunctionalTestCase):
    ...
    def getBusinessTemplateList(self):
        ...
        """
        return ('erp5_core_proxy_field_legacy', 'erp5_full_text_core', 'erp5_full_text_mroonga_catalog',
                ...
                'erp5_simulation',
                'erp5_trade',
                'erp5_ooo_import', 'erp5_ooo_import_core',
                'erp5_accounting', 'erp5_bank_reconciliation', 'erp5_invoicing',
...
def test_suite():
    ...
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestZeleniumCore))
    return suite
