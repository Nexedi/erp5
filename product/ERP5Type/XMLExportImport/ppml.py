...
if six.PY2:
  ...
  from Products.ERP5Type.patches import python_compat_pickle as _compat_pickle  # XXX this is not really a "patch", where to put this ?
else:
...
class ToXMLUnpickler(Unpickler):
    ...
    @register(PROTO)
    def load_proto(self):
        self.proto = proto = ord(self.read(1))
