...
class BusinessTemplateRoleDocumentationHelper(PortalTypeDocumentationHelper):
  """
    Provides access to all documentation information
    of a portal type relate to role definition in the 
    context of a business template.
  """
