...
from .component_package import (
  ComponentDynamicPackageType as _ComponentDynamicPackageTypePY3,
  ComponentVersionPackageType,
  ComponentImportError)
class ComponentDynamicPackageType(_ComponentDynamicPackageTypePY3):
  """
...
# TODO: Remove
  def reset(self, sub_package=None):
    ...
    if sub_package:
      ...
      self.fullname_source_code_dict.clear()
      package = self
