...
USE_COMPONENT_PY2_LOADER = sys.version_info < (3, 4)
  ...
  * Single PEP-0302 ComponentModuleLoader() class (load_module() API) and
  ...
  def find_load_module(self, name):
    ...
    try:
      ...
      if not USE_COMPONENT_PY2_LOADER or str(e) != "No module named " + name:
...
if not USE_COMPONENT_PY2_LOADER:
