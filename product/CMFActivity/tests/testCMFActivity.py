...
def for_each_activity(wrapped):
  def wrapper(self):
    ...
    for activity in activity_tool.activity_dict(activity_tool.getSQLConnection()):
...
class TestCMFActivity(ERP5TypeTestCase, LogInterceptor):
  ...
  def getMessageList(self, activity, **kw):
    activity_tool = self.portal.portal_activities
    return activity_tool.activity_dict(
      activity_tool.getSQLConnection())[activity].getMessageList(
      activity_tool, **kw)

  def deleteMessageList(self, activity, message_list):
    activity_tool = self.portal.portal_activities
    db = activity_tool.getSQLConnection()
    activity_tool.activity_dict(db)[activity].deleteMessageList(
  ...
  def test_68_TestMessageValidationAndFailedActivities(self):
    ...
    activity_dict = activity_tool.activity_dict(activity_tool.getSQLConnection())
  ...
  def test_115_TestSerializationTagSQLDictPreventsParallelExecution(self):
    ...
    activity = activity_tool.activity_dict(activity_tool.getSQLConnection())['SQLDict']
  ...
  def test_MessageNonExecutable(self):
    ...
    try:
      ...
      for kw['activity'] in activity_tool.activity_dict(activity_tool.getSQLConnection()):
