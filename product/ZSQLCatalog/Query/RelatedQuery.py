...
class RelatedQuery(Query):
  ...
  def asSQLExpression(self, sql_catalog, column_map, only_group_columns, renderer):
    sql_expression_list = [self.search_key.buildSQLExpression(sql_catalog, column_map, only_group_columns, self.group, renderer=renderer)]
    join_condition = self.join_condition
    if join_condition is not None:
      sql_expression_list.append(join_condition.asSQLExpression(sql_catalog, column_map, only_group_columns, renderer))
