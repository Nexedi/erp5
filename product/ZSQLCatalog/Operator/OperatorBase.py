...
def registerValueRenderer(renderer_dict):
  for obj_type, renderer in renderer_dict.items():
    value_renderer[obj_type] = renderer
...
class OperatorBase(object):
  ...
  def _renderValue(self, value,
    ...
    """
    return value_renderer_get(value.__class__, valueDefaultRenderer)(value, sql_connection_id = sql_connection_id)
