...
from Products.Database.db import hosed_connection
...
class TestDeferredConnection(ERP5TypeTestCase):
  ...
  def getBusinessTemplateList(self):
    return ('erp5_full_text_mroonga_catalog', 'erp5_full_text_sqlite_catalog')
  ...
  def test_00_basicReplaceQuery(self):
    ...
    connection.query(b'REPLACE INTO `full_text` (uid, SearchableText) VALUES (0, "dummy test")')
    try:
      self.commit()
