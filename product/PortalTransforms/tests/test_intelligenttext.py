...
def test_suite():
    ...
    suite = TestSuite()
    suite.addTest(defaultTestLoader.loadTestsFromTestCase(TestIntelligentTextToHtml))
    suite.addTest(defaultTestLoader.loadTestsFromTestCase(TestHtmlToIntelligentText))
    return suite
