...
class _ERP5(ERP5TypeTestSuite):
  ...
  def _getAllTestList(self):
    ...
    for test_path in chain(
        glob(path + '/bt5/erp5_configurator_standard/TestTemplateItem/portal_components/test.erp5.testStandardConfigurationWorkflow.py'),
        glob(path + '/bt5/erp5_configurator_ebusiness_lotse/TestTemplateItem/portal_components/test.erp5.testEbusinessLotseConfigurationWorkflow.py'),
        glob(path + '/bt5/erp5_user_tutorial/TestTemplateItem/portal_components/test.erp5.testFunctionalStandaloneUserTutorial.py'),
        glob(path + '/bt5/erp5_officejs_ui_test/TestTemplateItem/portal_components/test.erp5.testFunctionalOfficeJSCodeMirror.py')):
