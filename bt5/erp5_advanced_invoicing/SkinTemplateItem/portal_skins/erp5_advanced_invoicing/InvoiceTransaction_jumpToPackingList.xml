...
invoice.Base_jumpToRelatedObject(base_category=base_category, related=related, portal_type=portal_type)\n
        ...
        <item>
            ...
            <value> <string>base_category, portal_type=(), invoice_type=(), related=1, selection_name="", selection_index=0, form_id=\'view\', target_form_id=None, jump_from_relative_url=None</string> </value>
        </item>
        <item>
            <key> <string>id</string> </key>
            <value> <string>InvoiceTransaction_jumpToPackingList</string> </value>
        </item>
        <item>
