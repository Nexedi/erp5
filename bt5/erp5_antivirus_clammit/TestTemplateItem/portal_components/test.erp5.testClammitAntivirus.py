...
class TestClammitAntivirus(ERP5TypeTestCase):
  ...
  def test_analyse_safe_document(self, requests_post_mock):
    requests_post_mock.side_effect = self.getResponseMock(self._SANE_HTTP_STATUS_CODE)
  ...
  @mock.patch("requests.post")
  def test_analysed_infected_document(self, requests_post_mock):
