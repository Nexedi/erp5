...
(function (document, window, rJS, Handlebars, RSVP, loopEventListener, Node) {
  ...
  gadget_klass
    ...
    .declareMethod('render', function () {
      var g = this;
      return g.getUrlForList([
        {command: 'display', options: {page: "eci_directory"}},
        {command: 'display', options: {page: "eci_provider_list"}},
        {command: 'display', options: {page: "eci_solution_list"}},
        {command: 'display', options: {page: "eci_success_case_list"}},
        {command: 'display', options: {page: "eci_financial_list"}},
        {command: 'display', options: {page: "eci_reference_list"}}
      ])
