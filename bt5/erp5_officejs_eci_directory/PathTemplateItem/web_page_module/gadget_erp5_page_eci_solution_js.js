      ...
      return new RSVP.Queue()
        ...
        .push(function (solution) {
          ...
          if (solution.logo_url === "N/A" || solution.logo_url === "") {
            solution.logo_url = 'gadget_erp5_afs_camera.png?format=png';
          }
          ...
          if (solution.wikipedia_url === "N/A" || solution.wikipedia_url === "") {
            return solution;
          }
        ...
        .push(function (solution) {
          gadget.element.querySelector(".display-widget")
            .innerHTML = display_widget_table(solution);

          return gadget.updateHeader({page_title: solution.title});
        });
    });
