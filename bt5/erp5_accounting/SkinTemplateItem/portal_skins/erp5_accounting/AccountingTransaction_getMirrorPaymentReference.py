...
if source_section is not None and source_section.isMemberOf(section_category):\n
  return transaction.getDestinationPaymentReference()\n
return transaction.getSourcePaymentReference()\n
</string> </value>
        </item>
        <item>
        ...
        <item>
            ...
            <value> <string>AccountingTransaction_getMirrorPaymentReference</string> </value>
        </item>
      </dictionary>
    </pickle>
  </record>
