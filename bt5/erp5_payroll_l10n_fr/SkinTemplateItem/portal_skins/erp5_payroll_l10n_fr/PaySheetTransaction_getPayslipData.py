...
non_subject_amount = 'base_amount/payroll/report_section/fr/amount_non_subject_to_contribution'
gross_category = 'base_amount/payroll/report/salary/gross'
contribution_relief = 'base_amount/payroll/report_section/fr/contribution_relief'
income_tax = 'base_amount/payroll/report_section/fr/income_tax'
csg_crds_taxable_to_income_tax = 'base_amount/payroll/report_section/fr/csg_crds_taxable_to_income_tax'
csg_non_taxable_to_income_tax = 'base_amount/payroll/report_section/fr/csg_non_taxable_to_income_tax'
...
def groupSameReportSectionLine(line_to_group_list):
 ...
 # Check if can group by same rate
  ...
  new_value_list = []
  for _, value in tmp2_base_dict.iteritems():
...
for line_dict in line_dict_list:
  ...
  for base_contribution in line_dict['base_contribution_list']:
    if base_contribution.startswith('base_amount/payroll/report_section/fr/'):
      added_to_list = True
