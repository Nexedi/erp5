...
remuneration_bloc = {}
result = []
is_trainee = (True if enrollment_item.getContractType() == '29' else False)
is_corporate_executive = (True if enrollment_item.getContractType() == '80' else False)

career_start_date = enrollment_item.getCareerStartDate()
career_stop_date = enrollment_item.getCareerStopDate()
...
for remuneration_type, salary_type in remuneration_types:
  ...
  if remuneration_type == '002':
    usual_working_time = float(enrollment_item.getWorkingUnitQuantity())
