...
if employee and not employee.getRegistrationNumber():
  employee.Person_setRegistrationNumber(batch=1)
...
return document.Base_redirect('PDF_viewPDFJSPreview', keep_items={'portal_status_message': 'This document will send to maileva'})
