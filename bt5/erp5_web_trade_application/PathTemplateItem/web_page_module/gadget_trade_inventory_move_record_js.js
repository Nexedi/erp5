...
(function (window, document, RSVP, rJS, Handlebars, promiseEventListener, loopEventListener, $) {
  ...
  var gadget_klass = rJS(window),
    source = gadget_klass.__template_element
                              .querySelector(".view-inventory-move-record-template")
                              .innerHTML,
  ...
  gadget_klass
    ...
    .declareMethod("render", function (options) {
      ...
      return new RSVP.Queue()
        ...
        .push(function (html) {
          ...
          if (gadget.options.jio_key.indexOf('inventory_move_record_module/') == 0){
          ...
          line_count = 1;
          for(var i=2; i<=10; i++){
            if(options.doc["product"+i] != undefined && options.doc["product"+i] != ""){
              line_count = i
            }
          }
          ...
          return gadget.updateHeader({
            title: translateString("Inventory Move Record") + " " + gadget.options.doc.doc_id + " " + (gadget.options.doc.record_revision || 1)
          });
        })
        .push(function () {
    ...
    /////////////////////////////////////////
    // New version of the the Inventory Move Record
    /////////////////////////////////////////
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (result) {
          ...
          cloned_doc.portal_type = 'Inventory Move Record Temp';
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          ...
          return loopEventListener(
            gadget.props.element.querySelector('form.view-inventory-move-record-form'),
            'submit',
            false,
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (result) {
          ...
          for(i=2; i <= 10; i++){
            createOptions(gadget.props.element.querySelector('[name="quantity_unit'+i+'"]'), option_array, gadget.options.doc['quantity_unit'+i])
          }
        })
    })
