      ...
      return new RSVP.Queue()
        ...
        .push(function (listbox) {
          return listbox.render({
            ...
            query: {
              query: 'hidden_in_html5_app_flag:"0" AND portal_type:("Sale Record" OR "Sale Record Temp")',
              select_list: ['doc_id', 'product', 'quantity', 'quantity_unit', 'price', 'price_currency',
                            'nextowner', 'previousowner', 'previouslocation', 'batch', 'comment', 'date',
                            'local_state', 'inputusername', 'sync_flag', 'local_validation', 'portal_type'],
