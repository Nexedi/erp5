      ...
      return new RSVP.Queue()
        ...
        .push(function (listbox) {
          return listbox.render({
            ...
            query: {
              query: 'hidden_in_html5_app_flag:"0" AND portal_type:("Purchase Price Record" OR "Purchase Price Record Temp")',
              select_list: ['doc_id', 'product', 'priced_quantity', 'quantity_unit', 'base_price', 'price_currency',
                            'previousowner', 'comment', 'date', 'local_state', 'local_validation', 'inputusername', 'portal_type', 'sync_flag'],
