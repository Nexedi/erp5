...
(function (window, document, RSVP, rJS, Handlebars, promiseEventListener, loopEventListener, $) {
  ...
  var gadget_klass = rJS(window),
    source = gadget_klass.__template_element
                              .querySelector(".view-purchase-price-record-template")
                              .innerHTML,
  ...
  gadget_klass
    ...
    .declareMethod("render", function (options) {
      ...
      return new RSVP.Queue()
        ...
        .push(function (html) {
          ...
          gadget.props.element.querySelector('[name=previousowner_title]').setAttribute('readOnly', 'readOnly')
          gadget.props.element.querySelector('[name=previousowner_reference]').setAttribute('readOnly', 'readOnly')
          ...
          if (gadget.options.jio_key.indexOf('purchase_price_record_module/') == 0){
          ...
          if (!(gadget.options.doc.local_state == "validated" || ["self", "manager", "hqmanager"].indexOf(gadget.options.doc.local_validation) >= 0)){
            var create_purchase_record_button = gadget.props.element.querySelector("input[type=button][name=create_purchase_record]");
            create_purchase_record_button.parentNode.removeChild(create_purchase_record_button);
          }
          ...
          return gadget.updateHeader({
            title: translateString("Purchase Price Record") + " " + gadget.options.doc.doc_id + " " + (gadget.options.doc.record_revision || 1)
          });
        })
        .push(function () {
    ...
    /////////////////////////////////////////
    // New version of the the Purchase Price Record
    /////////////////////////////////////////
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (result) {
          ...
          cloned_doc.portal_type = 'Purchase Price Record Temp';
    ...
    .declareService(function () {
      ...
      if(gadget.props.element.querySelector('input[type=button][name=create_purchase_record]') == null){
        return;
      }
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          ...
          return promiseEventListener(
            gadget.props.element.querySelector('input[type=button][name=create_purchase_record]'),
            'click',
            false
          );
        })
        .push(function (click_event) {
          var doc = {
            ...
            portal_type: "Purchase Record Temp",
            doc_id: getSequentialID('PR'),
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          return loopEventListener(
            gadget.props.element.querySelector('form.view-purchase-price-record-form'),
            'submit',
            false,
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function(){createPriceCurrencySelection(gadget, gadget.options.doc.price_currency)})
    })
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (){
          $(gadget.props.element.querySelector("option[value='"+gadget.options.doc.product_line+"']")).attr("selected", true);
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (){
          $(gadget.props.element.querySelector("option[value='"+gadget.options.doc.default_address_region+"']")).attr("selected", true);
              ...
              return new RSVP.Queue()
                ...
                .push(function (result) {
                  ...
                  if (result !== undefined) {
                    ...
                    gadget.props.element.querySelector('[name="previousowner_title"]').readOnly = false;
                    gadget.props.element.querySelector('[name="previousowner_reference"]').readOnly = false;
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          return gadget.allDocs({
            query: 'portal_type:"Product" AND title_lowercase:"' + gadget.props.element.querySelector('[name=product_title]').value.toLowerCase() + '"',
            limit: [0, 2]
            });
        })
        .push(function (result) {
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          return gadget.allDocs({
            query: 'portal_type:("Organisation" OR "Organisation Temp") AND title_lowercase:"' + gadget.props.element.querySelector('[name=previousowner_title]').value.toLowerCase() + '"',
            limit: [0, 2]
            });
        })
        .push(function (result) {
