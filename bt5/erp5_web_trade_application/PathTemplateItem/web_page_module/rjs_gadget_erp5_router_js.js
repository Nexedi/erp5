...
(function (window, rJS, RSVP, loopEventListener, document, jIO, URI, URL) {
 ...
 //   command_options.args.jio_key = command_options.path || undefined;
     command_options.args.jio_key = command_options.args.page;
    ...
    if(command_options.args.page =="worklist"){
    return {
      url: "gadget_erp5_page_" + command_options.args.page + ".html",
    ...
    else if(command_options.args.page =="sync"||command_options.args.page =="setting"){
    return {
      url: "gadget_gkr_page_"+command_options.args.page+".html",
    ...
    return {
     // url: "gadget_erp5_page_" + command_options.args.page + ".html",
       url: "gadget_gkr_jio_" + command_options.args.page +"_view"+ ".html",
    //url: "gadget_gkr_page_sync.html",
