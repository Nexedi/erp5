...
(function (window, document, RSVP, rJS, Handlebars, promiseEventListener, loopEventListener, $) {
  ...
  var gadget_klass = rJS(window),
    source = gadget_klass.__template_element
                              .querySelector(".view-sale-record-template")
                              .innerHTML,
  ...
  gadget_klass
    ...
    .declareMethod("render", function (options) {
      ...
      return new RSVP.Queue()
        ...
        .push(function (html) {
          ...
          if (gadget.options.jio_key.indexOf('sale_record_module/') == 0){
          ...
          return gadget.updateHeader({
            title: translateString("Sale Record") + " " + gadget.options.doc.doc_id + " " + (gadget.options.doc.record_revision || 1)
          });
        })
        .push(function () {
    ...
    /////////////////////////////////////////
    // New version of the the Sale Record
    /////////////////////////////////////////
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (result) {
          ...
          cloned_doc.portal_type = 'Sale Record Temp';
      ...
      return new RSVP.Queue()
        ...
        .push(function () {
          ...
          return loopEventListener(
            gadget.props.element.querySelector('form.view-sale-record-form'),
            'submit',
            false,
            function (submit_event) {
              return new RSVP.Queue()
                .push(function () {
                  ...
                  if (doc.sync_flag != "1"){
                    doc.portal_type = 'Sale Record Temp' // For to avoid sync
                  }
