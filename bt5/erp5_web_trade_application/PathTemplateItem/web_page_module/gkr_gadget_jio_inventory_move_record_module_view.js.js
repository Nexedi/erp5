      ...
      return new RSVP.Queue()
        .push(function () {
          return gadget.getUrlFor({jio_key: options.jio_key,
                                   page: "add_inventory_move_record"});
        })
        .push(function (url) {
          return gadget.updateHeader({
            title: "Inventory Move Record",
            right_url: url,
            right_title: "New"
          });
        })
        ...
        .push(function (listbox) {
          return listbox.render({
            ...
            column_list: [{
              ...
              select: 'previouslocation',
              title: 'Output Warehouse Or Bin'
            }, {
              select: 'nextlocation',
              title: 'Input Warehouse Or Bin'
            },{
              select: 'batch',
              title: 'Batch'
            },{
            ...
            query: {
              query: 'hidden_in_html5_app_flag:"0" AND portal_type:("Inventory Move Record" OR "Inventory Move Record Temp")',
              select_list: ['doc_id', 'product', 'quantity', 'quantity_unit', 'previousowner', 'previouslocation', 'nextlocation', 'date', 'batch', 'comment', 'local_state', 'inputusername', 'sync_flag', 'local_validation', 'portal_type'],
