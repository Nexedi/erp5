...
if attachment_count or bad_file:
  ...
  if context.PDFDocument_getRequirementCount() != 0: 
...
#if context.PDFDocument_getRequirementCount() != 0: 
#  return context.Base_redirect('PDFDocument_viewAttachmentList', keep_items = dict(portal_status_message=message), **kw)
