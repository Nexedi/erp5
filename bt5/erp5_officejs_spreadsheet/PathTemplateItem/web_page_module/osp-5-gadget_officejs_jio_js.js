...
(function (window, rJS, jIO) {
  ...
  rJS(window)
    ...
    .declareMethod('createJio', function (jio_options) {
      ...
      // Check if erp5 is the right storage.
      this.state_parameter_dict.jio_storage = jIO.createJIO(jio_options);
      return this.getSetting("jio_storage_name")
        .push(function (jio_storage_name) {
          if (jio_storage_name === "ERP5") {
              if (jio_options.type !== "replicate" ||
                  jio_options.remote_sub_storage.type !== "mapping" ||
                  jio_options.remote_sub_storage.sub_storage.type !== "erp5"  ||
                  jio_options.local_sub_storage.type !== "compatibility") {
