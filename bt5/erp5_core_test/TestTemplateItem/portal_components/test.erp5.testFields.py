...
def test_suite():
  ...
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestRenderViewAPI))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestFloatField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestIntegerField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestStringField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestDateTimeField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestTextAreaField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestLinesField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestCheckBoxField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestListField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestMultiListField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestProxyField))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestFieldValueCache))
  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(TestCaptchaField))
