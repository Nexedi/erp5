...
class TestBusinessTemplate(BusinessTemplateMixin):
  ...
  def test_update_business_template_with_category_having_subcategory_tree_modified(self):
    ...
    Updating from:
        ...
        portal_categories/test_category/modified_categorie
        portal_categories/test_category/modified_categorie/container_in_which_child_is_added
        portal_categories/test_category/modified_categorie/container_in_which_child_is_added/child_kept
        portal_categories/test_category/modified_categorie/removed

    to:

        portal_categories/test_category/modified_categorie   <-- this will be modified
        portal_categories/test_category/modified_categorie/container_in_which_child_is_added
        portal_categories/test_category/modified_categorie/container_in_which_child_is_added/child_kept
        portal_categories/test_category/modified_categorie/container_in_which_child_is_added/added
    ...
    parent_category = base_category.newContent(portal_type='Category', id='modified_categorie')
    ...
    parent_category.setTitle('modified_categorie')
    ...
    try:
      ...
      self.tic()
      portal_categories.test_category.modified_categorie.container_in_which_child_is_added.setTitle(
    ...
    self.assertEqual(
      'This path should not be reinstalled during update',
      portal_categories.test_category.modified_categorie.container_in_which_child_is_added.getTitle())
...
class TestDocumentTemplateItem(_LocalTemplateItemMixin,
  ...
  document_data = """from Products.ERP5Type.Base import Base
...
"""
  document_data_updated = """from Products.ERP5Type.Base import Base
from Products.ERP5Type.Globals import InitializeClass
from AccessControl import ClassSecurityInfo
