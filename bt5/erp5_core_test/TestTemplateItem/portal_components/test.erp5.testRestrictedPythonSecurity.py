...
class TestRestrictedPythonSecurity(ERP5TypeTestCase):
  ...
  def testIpAddressModuleAllowance(self):
    ...
    self.createAndRunScript('''
        from ipaddress import ip_address
        return ip_address('2a01:cb14:818:0:7312:e251:f251:ffbe').is_global
        ''')
    self.createAndRunScript('''
        from ipaddress import ip_network
        return ip_network('2a01:cb14:818:0:7312:e251:f251::/112').is_private
        ''')
    self.createAndRunScript('''
        from ipaddress import ip_address, ip_network
        return ip_address('2a01:cb14:818:0:7312:e251:f251:ffbe') in ip_network('2a01:cb14:818:0:7312:e251:f251::/112')
        ''')
    self.createAndRunScript('''
        from ipaddress import ip_interface
        return ip_interface('2a01:cb14:818:0:7312:e251:f251:ffbe').with_prefixlen
        ''')
