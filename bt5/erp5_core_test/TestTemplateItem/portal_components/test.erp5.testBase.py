...
#     new_group_value = '%s_a' % current_title
  ...
  def stepCreateTempObject(self, sequence=None, sequence_list=None, **kw):
    ...
    """
    portal = self.getPortal()
    tmp_object = portal.newContent(temp_object=True, portal_type="Organisation", id="a_wonderful_id")
    sequence.edit(
  ...
  def stepCreateTempClass(self, sequence=None, sequence_list=None, **kw):
    ...
    """
    portal = self.getPortal()
    tmp_object = portal.newContent(temp_object=True, portal_type="Amount", id="another_wonderful_id")
    sequence.edit(
        object_instance=tmp_object,
        current_title='',
        current_group_value=None
