...
now = DateTime()
now_minus_6 = now - old_div(1.0/24,60)*6
now_minus_1 = now - old_div(1.0/24,60)*1
...
person_per_hour = old_div(60*person_count,5)
sale_order_per_hour = old_div(60*sale_order_count,5)
