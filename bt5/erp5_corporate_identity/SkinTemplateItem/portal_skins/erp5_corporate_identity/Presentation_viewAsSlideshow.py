...
if context.getPortalType() in ["Presentation"]:
  ...
  ## Comment below might be obsolete, this was before fixing a bug where we
  ## iterated directly in the binary data from .zip raw content, which was
  ## somehow OK on python2
  #
