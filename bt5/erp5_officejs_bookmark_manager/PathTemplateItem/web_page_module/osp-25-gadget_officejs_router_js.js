    ...
    .declareMethod('route', function (options) {
      ...
      if (args.access_token) {
        if(args.state === "gdrive") {
          page = "jio_gdrive_configurator";
        } else {
          page = "jio_dropbox_configurator";
        }
        return this.getCommandUrlFor({"page": page,
      ...
      if (args.jio_key === undefined || args.jio_key === '') {
        if (args.page === undefined || args.page === '' || args.page === "bookmark_list") {
