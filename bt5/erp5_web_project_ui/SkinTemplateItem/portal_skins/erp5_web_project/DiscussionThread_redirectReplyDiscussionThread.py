...
portal_status_message = "Reply"
form_id = 'DiscussionThread_viewReaderForm'
redirect_url = '%s/%s' % (context.absolute_url(), form_id)

return context.Base_redirect(form_id="DiscussionThread_viewCreateNewDiscussionPostDialog")
