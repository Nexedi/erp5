...
class WechatService(XMLObject):
  ...
  def callWechatApi(self, URL, wechat_dict):
    ...
    if return_code=="SUCCESS":
      ...
      if result_code=="SUCCESS":
        ...
        raise Exception(u"ERROR result_code {}: {}".format(result_code, result_dict_content.get("err_code_des")))
    else:
      raise Exception(u"ERROR return_code {}: {}".format(return_code, result_dict_content.get("return_msg")))
  ...
  def getWechatPaymentURL(self, wechat_dict):
    ...
    return self.callWechatApi(self.ORDER_URL, wechat_dict)['code_url']
