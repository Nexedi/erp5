...
class TestCommerce(ERP5TypeTestCase):
  ...
  def test_09_paymentRedirect(self):
    ...
    self.assertTrue(quote("You need to create an account to " \
    ...
    self.assertTrue(quote("SaleOrder_viewAsWeb") in
                    self.app.REQUEST.RESPONSE.getHeader('location'))
  ...
  def test_10_deleteShoppingCartItem(self):
    ...
    self.assertTrue(quote("Please select an item.") in
                               self.app.REQUEST.RESPONSE.getHeader('location'))
    ...
    self.assertTrue(
              quote("Successfully removed from shopping cart.") in
                 self.app.REQUEST.RESPONSE.getHeader('location'))
