...
(function (window, rJS, RSVP) {
  ...
  function setjIOERP5Configuration(gadget) {
    ...
    var version = gadget.props.element.querySelector("input[name='version']").value;
    return gadget.getSetting("portal_type")
      .push(function (portal_type) {
        var erp5_url_hateoas = (new URI("hateoas"))
                .absoluteTo(erp5_url)
                .toString();
      ...
      .push(function () {
        return RSVP.all([
          gadget.setGlobalSetting('erp5_url', erp5_url),
          gadget.setGlobalSetting('document_version', version)
        ]);
      })
      .push(function () {
  ...
  gadget_klass
    ...
    .declareService(function () {
      ...
      return new RSVP.Queue()
        ...
        .push(function (global_setting_gadget) {
          return RSVP.all([
            global_setting_gadget.getSetting("erp5_url"),
            global_setting_gadget.getSetting("document_version")
          ]);
        })
        .push(function (result) {
          var erp5_url_input =
            gadget.props.element.querySelector("input[name='erp5_url']"),
          document_version = gadget.props.element.querySelector("input[name='version']");
          document_version.value = result[1] || "codeeditor";
          erp5_url_input.value = result[0] || "https://www.example.org";
