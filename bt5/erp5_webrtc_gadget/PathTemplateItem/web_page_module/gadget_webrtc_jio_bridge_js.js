...
(function (rJS, window, RSVP) {
  ...
  function registerAnswer (gadget, description) {
    return gadget.props.webrtc_connections["webrtc" + gadget.props.counter].setRemoteDescription(description)
      .push(function () {
    ...
    .push(function(webrtc_gadget) {
      ...
      if (options.initiator === true) {
        ...
        .push(function (description) {
          var params = {'name': options.to+'_'+options.peerid, 'data' : new Blob([JSON.stringify({from: options.peerid, action: "offer", data: description})], 
        ...
        .push(function (answer) {
          var params = {name: options.to+'_'+options.peerid, data: new Blob([JSON.stringify({to: options.to, action: "answer", data: answer})], 
                                                  {type : "application/json"}) };
          return handler_gadget.handle_answer(options.roomid, params);
        })
        .push(function () {
