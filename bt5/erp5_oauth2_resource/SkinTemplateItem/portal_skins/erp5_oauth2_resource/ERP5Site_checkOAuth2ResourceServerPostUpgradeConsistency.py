...
extraction_plugin_type_name = 'IExtractionPlugin'
...
try:
  extractor_plugin_list = plugins.listPlugins(extraction_plugin_type_name)
except KeyError:
  extractor_plugin_list = []
if not extractor_plugin_list:
  ...
  if fixit:
    ...
    for info in plugins.listPluginTypeInfo():
      if info['id'] == extraction_plugin_type_name:
