  ...
  #   result_dict['_relative_url'] = traversed_document.getRelativeUrl()
    ...
    for erp5_action_key in erp5_action_dict.keys():
      ...
      for view_action in erp5_action_dict[erp5_action_key]:
        ...
        if erp5_action_key in (view_action_type, "view", "workflow", "object_new_content_action", "object_clone_action", "object_delete_action", "object_report_jio", "object_search_jio"):
