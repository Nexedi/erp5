...
""")
  @createIndexedDocument()
  @changeSkin('Hal')
  def test_getHateoas_proxy_listbox_editable_field_2(self, **kw):
    # For this test, we use/build this kind of a proxyfication target chain.
    # ie FooModule_viewFooList.listbox targeting to FooModule_viewFieldLibrary and targeting to Base_viewFieldLibrary.my_list_mode_listbox
