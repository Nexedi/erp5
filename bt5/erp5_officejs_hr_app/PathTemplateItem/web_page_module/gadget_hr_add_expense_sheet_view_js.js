...
(function (window, document, RSVP, rJS, Handlebars, loopEventListener, promiseEventListener, alertify) {
  ...
  function drawSvgString(title, number) {
    var i = 0,
      ...
      step = 80,
      string_title_number = '',
      base = '<svg xmlns="http://www.w3.org/2000/svg" width="2970" height="2100"><g><title>' + (title + ' ' + number)+ '</title><rect x="-1" y="-1" width="2972" height="2102" id="canvas_background" fill="#b2b2b2"/><rect id="svg" width="100%" height="100%" x="0" y="0" stroke-width="0" fill="url(#gridpattern)"/></g><g>';
    if (! title && !number) {
      return '';
    }
        ...
        .push(function () {
          return RSVP.any([
            loopEventListener(
              ...
              false,
              function (event) {
                drawSvgString(event.target.value, gadget.props.element.querySelector('.number').value);
