...
(function (window, rJS, RSVP, console, domsugar, Intl, Query, SimpleQuery,
  ...
  rJS(window)
    ...
    .declareMethod('render', function render(options) {
      ...
      //fake options
      //options.allDocs_result = JSON.parse("{\"data\":{\"rows\":[{\"id\":\"event_module/20241121.002-5BA348EF\",\"value\":{\"asStrippedHTML\":\"Dear User,\\n<br />\\n<br />On the Instance Tree &quot;[THEIA] Playground&quot; the following instance\\n<br />is reporting an error:\\n <br />\\n  <br />theia1\\n  <br />\\n  <br /> Message:\\n  <br />#error while instanciating: 7cc0b\\\\&#x27;\\\\n2024-11-21 01:54:57 slapos[3592170] INFO Finished software releases.\\\\n&#x27;\\n  <br />\\n<br />Those kind of failures indicate a problem on your services, even if they \\n<br />seem to be normal, it is important to investigate. \\n<br />\\n<br />If this service is not hosted on a Compute Node owned by you, our support team is \\n<br />going to check the state of your system as soon as possible.\\n<br />\\n<br />This is an automatic message generated by our monitoring system.\",\"movement.start_date\":\"Thu, 21 Nov 2024 09:03:15 +0000\",\"Event_getSafeSourceTitle\":\"NEXEDI HOSTING\",\"Event_getAttachmentList\":[]}},{\"id\":\"event_module/20241122.022-4BE85027\",\"value\":{\"asStrippedHTML\":\"<p>Can you please check your resiliency?<br /><br />Thanks,<br />Romain</p>\",\"movement.start_date\":\"Fri, 22 Nov 2024 10:13:09 +0000\",\"Event_getSafeSourceTitle\":\"NEXEDI HOSTING\",\"Event_getAttachmentList\":[]}},{\"id\":\"event_module/20241219.019-20B68A94\",\"value\":{\"asStrippedHTML\":\"<p>I destroyed all PBS slaves, which must be recreated</p>\",\"movement.start_date\":\"Thu, 19 Dec 2024 09:19:49 +0000\",\"Event_getSafeSourceTitle\":\"NEXEDI HOSTING\",\"Event_getAttachmentList\":[]}}],\"total_rows\":3}}");
      options.begin_from = 0;
      options.first_render = true;
      options.lines = 100;
      //options.query_string = "( portal_type: ( = \"Discussion Thread\" OR = \"Discussion Post\" ) AND follow_up__uid: = \"182575375\" )";
      options.query_string = "( portal_type: ( = \"Discussion Thread\" OR = \"Discussion Post\" ) )";
      options.render_timestamp = 1735919582075;
      //options.source_column = "Event_getSafeSourceTitle";
      options.query_dict = {
        portal_type: ['Discussion Thread', 'Discussion Post']/*,
        //follow_up__uid: 182575375
        follow_up__uid: 44660*/
      };
      console.log("options.query_dict:", options.query_dict);
      console.log("Object.entries(options.query_dict):", Object.entries(options.query_dict));
      console.log("CREATED QUERY:", Query.objectToSearchText(
              new ComplexQuery({
                operator: "AND",
                type: "complex",
    ...
    .declareJob('fetchLineContent', function fetchLineContent(only_cancel) {
      ...
      gadget.state.query_string = 'portal_type: "Discussion Post" AND parent_relative_url: "discussion_forum_module/12/1"';
      console.log("jio_allDocs with query:", gadget.state.query_string);
      return gadget.jio_allDocs({
        query: gadget.state.query_string,
        limit: limit_options,
        select_list: [gadget.state.date_column,
        ...
        .push(function (result) {
          console.log("jio_allDocs result:", result);
          return gadget.changeState({
