    ...
    .onStateChange(function (modification_dict) {
      ...
      if (modification_dict.hasOwnProperty("editable")) {
        queue
          ...
          .push(function () {
            return RSVP.all([
              context.getUrlFor({command: 'display', options: {page: "drive_app_document_list"}}),
              context.getUrlFor({command: 'display', options: {page: "drive_app_car"}}),
              context.getUrlFor({command: 'display', options: {page: "drive_app_configurator"}}),
          ...
          .push(function (result_list) {
            return context.translateHtml(
              panel_template_body_list({
                ...
                "car_href": result_list[1],
                "storage_href": result_list[2],
