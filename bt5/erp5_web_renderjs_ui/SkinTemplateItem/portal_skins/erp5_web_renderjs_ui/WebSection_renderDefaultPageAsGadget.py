...
mapping_dict = {
  ...
  "app_configuration": web_section.getLayoutProperty("configuration_app_configuration", default=""),
  "hateoas_appcache": web_section.getLayoutProperty("configuration_hateoas_appcache", default="hateoas_appcache"),
