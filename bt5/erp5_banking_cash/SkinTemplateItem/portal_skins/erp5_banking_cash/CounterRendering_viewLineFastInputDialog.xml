...
if currency != context.Baobab_getPortalReferenceCurrencyID():\n
  ...
  emission_letter = [\'not_defined\', ]\n
  if context.getSource() is not None:\n
    source_letter = context.Baobab_getSiteEmissionLetter(context.Baobab_getVaultSite(context.getSourceValue().getRelativeUrl()))\n
    emission_letter.append(source_letter)\n
...
return context.CashDelivery_generateCashDetailInputDialog(listbox = None\n
                                                          ...
                                                          , rendering_vault = context.getSource()\n
                                                          )\n
</string> </value>
        </item>
        <item>
        ...
        <item>
            ...
            <value> <string>CounterRendering_viewLineFastInputDialog</string> </value>
        </item>
        <item>
