...
cash_status = [\'valid\']\n
cash_detail_dict= { \'line_portal_type\'          : \'Outgoing Cash Exchange Line\'        # The portal type that the fastinput will create\n
...
return context.CashDelivery_generateCashDetailInputDialog(listbox = None\n
        ...
        <item>
            ...
            <value> <string>CashExchange_viewOutgoingLineFastInputDialog</string> </value>
        </item>
      </dictionary>
    </pickle>
  </record>
