    ...
    <pickle>
      <dictionary>
        ...
        <item>
            ...
            <value> <string>"""Update relative entity with a credential update. Allow to update a organisation or a person for exemple"""\n
...
for destination_decision in context.getDestinationDecisionValueList():\n
  ...
  getattr(context,\'CredentialUpdate_update%sInformation\' % portal_type)()\n
        ...
        <item>
            ...
            <value> <string>CredentialUpdate_updateRelatedEntity</string> </value>
        </item>
      </dictionary>
    </pickle>
  </record>
