...
class TestERP5Credential(ERP5TypeTestCase):
  ...
  def stepCreateSubscriptionRequestWithSecurityQuestionCategory(self, sequence=None,
    ...
    self.assertNotIn('portal_status_message=Thanks%20for%20your%20registration.%20You%20will%20be%20receive%20an%20email%20to%20activate%20your%20account.', result)
