...
class JSONForm(JSONType, TextDocument):
  ...
  def __call__(self, text_content="", list_error=False): #pylint:disable=arguments-differ
    validation_result = self.validateJSON(text_content, list_error)
  ...
  def validateJSON(self, json_text, list_error=False):
    """
