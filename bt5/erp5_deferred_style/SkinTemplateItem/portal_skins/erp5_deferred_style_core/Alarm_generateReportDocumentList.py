...
for idx, report_data in enumerate(getattr(context, report_configuration_script_id)()):
  ...
  if report_data.get('mode') == 'view':
    ...
    # erp5 report
    report_context.Base_computeReportSection(
