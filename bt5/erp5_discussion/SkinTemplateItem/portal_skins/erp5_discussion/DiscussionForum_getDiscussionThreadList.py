...
discussion_thread_list = [x.getObject() for x  in context.searchResults(portal_type="Discussion Thread", sort_on=[('modification_date', 'descending')])] #searches in all erp5 docs linked to this predicate config
