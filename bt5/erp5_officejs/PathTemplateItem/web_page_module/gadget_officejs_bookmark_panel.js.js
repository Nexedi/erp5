    ...
    .onStateChange(function (modification_dict) {
      ...
      if (modification_dict.hasOwnProperty("editable")) {
        queue
          ...
          .push(function () {
            return RSVP.all([
              context.getUrlFor({command: 'display', options: {page: "ojs_bookmark_list"}}),
              ...
              context.getUrlFor({command: 'display', options: {page: "ojs_bookmark_dispatcher"}}),
              context.getUrlFor({command: 'display', options: {page: "ojs_bookmark_preference"}})
            ]);
          })
          .push(function (result_list) {
            return context.translateHtml(
              panel_template_body_list({
                ...
                "bookmark_dispatcher_href": result_list[3],
                "bookmark_preference_href": result_list[4]
              })
            );
          })
