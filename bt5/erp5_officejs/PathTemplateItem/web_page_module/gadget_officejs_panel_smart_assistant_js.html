    ...
    .onStateChange(function (modification_dict) {
      ...
      if (modification_dict.hasOwnProperty("editable")) {
        queue
          ...
          .push(function () {
            return RSVP.all([
              context.getUrlFor({command: 'display', options: {page: "ojs_smart_assistant_document_list"}}),
              ...
              context.getUrlFor({command: 'display', options: {page: "ojs_smart_assistant_home"}})
            ]);
          })
