...
if typing.TYPE_CHECKING:
  ...
  from erp5.portal_type import OpenAPIType as OpenAPITypeInformation  # pylint:disable=no-name-in-module
...
class OpenAPIService(XMLObject):
  ...
  def getMatchingOperation(self, request):
    ...
    request_path_parts = request.physicalPathFromURL(
      request.get('URL'), )[len(self.getPhysicalPath()):]
  ...
  if typing.TYPE_CHECKING:
    ...
    def getTypeInfo(self):
      # type: () -> OpenAPITypeInformation
      return OpenAPITypeInformation()
