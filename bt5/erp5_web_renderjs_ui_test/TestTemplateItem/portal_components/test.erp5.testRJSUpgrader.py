...
class TestRenderJSUpgrade(ERP5TypeTestCase, unittest.TestCase):
  ...
  def test_upgrade_fix_modification_date(self):
    ...
    self.assertGreater(
        ...
        self.javascript.getModificationDate())
    self.assertIn(
        'Last modified by WebSite_checkAppcacheModificationDateConsistency on',
