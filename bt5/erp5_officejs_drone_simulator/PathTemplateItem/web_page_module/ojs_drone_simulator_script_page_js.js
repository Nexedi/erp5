...
(function (window, rJS, domsugar, document, Blob) {
  ...
  rJS(window)
    ...
    .declareJob('runGame', function runGame(options) {
      ...
      game_parameters_json = {
        "drone": {
          "maxAcceleration": parseInt(options.drone_acceleration),
          "minSpeed": parseInt(options.drone_min_speed),
          "speed": parseInt(options.drone_speed),
          "maxSpeed": parseInt(options.drone_max_speed),
          "maxRoll": parseInt(options.drone_max_roll)
        },
        "gameTime": parseInt(options.simulation_time),
        "simulation_speed": parseInt(options.simulation_speed),
        "latency": {
          "information": 0,
          "communication": 0
        },
        "map": {
          ...
          "height": parseInt(options.map_height),
          "start_AMSL": parseInt(options.start_AMSL)
        },
        "initialPosition": {
          "longitude": parseFloat(options.init_pos_lon),
          "latitude": parseFloat(options.init_pos_lat),
          "z": parseInt(options.init_pos_z)
        },
