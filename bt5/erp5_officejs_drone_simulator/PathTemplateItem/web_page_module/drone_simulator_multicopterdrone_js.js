...
var MulticopterDroneAPI = /** @class */ (function () {
  ...
  */
  MulticopterDroneAPI.prototype.internal_start = function (drone) {
    ...
    if (drone._minSpeed < 0) {
      throw new Error('min speed must be superior or equal to 0');
    }
  ...
  */
  ...
  MulticopterDroneAPI.prototype.getMinPitchAngle = function () {
    return this._flight_parameters.drone.minPitchAngle;
  };
  MulticopterDroneAPI.prototype.getMaxPitchAngle = function () {
