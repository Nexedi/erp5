...
var DroneManager = /** @class */ (function () {
  ...
  DroneManager.prototype.loiter = function (x, y, z, radius) {
    this._internal_setTargetCoordinates(x, y, z, true);
    this._API.set_loiter_radius(radius);
  };
