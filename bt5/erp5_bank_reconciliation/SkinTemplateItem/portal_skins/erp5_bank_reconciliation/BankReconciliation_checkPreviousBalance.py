    ...
    <pickle>
      <dictionary>
        ...
        <item>
            ...
            <value> <string>"""Returns true if the reconciled balance at the begin date of this bank reconciliation\n
...
return round(context.getQuantityRangeMin(), precision) \\\n
  == round(context.BankReconciliation_getReconciledAccountBalance(\n
        ...
        <item>
            ...
            <value> <string>BankReconciliation_checkPreviousBalance</string> </value>
        </item>
      </dictionary>
    </pickle>
  </record>
