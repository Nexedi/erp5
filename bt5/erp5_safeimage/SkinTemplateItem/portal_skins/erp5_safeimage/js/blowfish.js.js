    ...
    * バイナリモード
    ...
    ex)
    blowfish.binMode = 1;
    cipherData       = blowfish.encrypt( 略.... );
    
    上記の様に暗号・復号前に blowfish.binMode に真となる値を代入することで
