...
# I executed this script in fish with:
#   ls **Item/portal_components/**.xml | xargs -n10 -P10 ~/srv/slapos/soft/7b82cba46eead19d8388b0a3359c6185/bin/python rewrite.py $x
#   ls **/PathTemplateItem/*module/**.xml | xargs -n10 -P10 ~/srv/slapos/soft/7b82cba46eead19d8388b0a3359c6185/bin/python rewrite.py $x
#   ls **/PathTemplateItem/portal*/**.xml | xargs -n10 -P10 ~/srv/slapos/soft/7b82cba46eead19d8388b0a3359c6185/bin/python rewrite.py $x
#
# it's not so clever way, but it deals with with limit of arguments list and
# still executes in parrallel.
