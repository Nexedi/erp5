...
for filename in sys.argv[1:]:
  with open(filename) as f:
    ...
    # this script does not know how to convert 
    if tree.xpath(
        '//record/pickle/tuple/global[@name="WorkflowHistoryList" and @module="Products.ERP5Type.patches.WorkflowTool"]'
      ):
      print ('🙈 ', filename, "skipped because it has multiple entry WorkflowHistoryList")
      continue
    ...
    if not class_name_elements:
      print ('✅ ', filename, "does not have contain old-style WorkflowHistoryList")
      continue
