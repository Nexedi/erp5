...
all_processing_type = context.Ticket_getResourceItemList(portal_type='Insolvency Proceeding', use_relative_url='portal_categories/use/crm/insolvency_proceeding', include_context=False, empty_item=False)
